...
def test_create_backtest(backtest_session):
    ...
    adapter.register_uri("POST", "http://127.0.0.1:8080/api/v1/backtests", json=created_backtest)
...
def test_create_backtest_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("POST", "http://127.0.0.1:8080/api/v1/backtests", json={}, status_code=500)
...
def test_get_backtest(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1", json={})
...
def test_get_backtest_negative(backtest_session):
    backtest, adapter = backtest_session()
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1", status_code=500)
...
def test_delete_backtest(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("DELETE", "http://127.0.0.1:8080/api/v1/backtests/1")
    backtest.delete_backtest(1)


def test_delete_backtest_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("DELETE", "http://127.0.0.1:8080/api/v1/backtests/1", status_code=500)
...
def test_list_backtest_services(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1/services", json=[])
...
def test_list_backtest_services_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1/services", status_code=500)
...
def test_add_backtest_services(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("PUT", "http://127.0.0.1:8080/api/v1/backtests/1/service")
    backtest.add_backtest_service(1, {})


def test_add_backtest_services_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("PUT", "http://127.0.0.1:8080/api/v1/backtests/1/service", status_code=500)
...
def test_list_sessions(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1/sessions", json=[])
    assert backtest.list_sessions(1) == []


def test_list_sessions_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1/sessions", status_code=500)
...
def test_create_session(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("POST", "http://127.0.0.1:8080/api/v1/backtests/1/sessions", json={})
    assert backtest.create_session(1) == {}


def test_create_session_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("POST", "http://127.0.0.1:8080/api/v1/backtests/1/sessions", status_code=500)
...
def test_get_session(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("GET", "http://127.0.0.1:8080/api/v1/backtests/1/sessions/1", json={})
...
def test_delete_session(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("DELETE", "http://127.0.0.1:8080/api/v1/backtests/1/sessions/1")
    assert backtest.delete_session(1, 1) is True


def test_delete_session_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("DELETE", "http://127.0.0.1:8080/api/v1/backtests/1/sessions/1", status_code=500)
...
def test_run_session(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("POST", "http://127.0.0.1:8080/api/v1/backtests/1/sessions/1/run", json={})
    assert backtest.run_session(1, 1, {}) == {}


def test_run_session_negative(backtest_session):
    backtest, adapter = backtest_session()
    adapter.register_uri("POST", "http://127.0.0.1:8080/api/v1/backtests/1/sessions/1/run", status_code=500)
