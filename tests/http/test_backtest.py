...
from foreverbull_core.models.backtest import EngineConfig, Config, Session
...
def test_create_backtest(backtest_session):
    ...
    engine = EngineConfig(start_date="2020-01-01", end_date="2022-12-31", timezone="utc", benchmark="AAPL", assets=["AAPLE", "TSLA"])
...
def test_run_session(backtest_session):
    ...
    assert backtest.run_session("b_id", "s_id") == None
