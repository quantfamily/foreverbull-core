...
def test_asset():
    a = Asset(sid=123, symbol="AAPL", asset_name="Apple",
    exchange="QUANDL")
...
def test_order():
    ...
    order = Order(id="order_id", asset=a, amount=10,
    filled=10, commission=0, limit_price=133.7,
    current_date="2017-01-01", created_date="2017-01-01",
    status=order_status)
...
def test_position():
    a = Asset(sid=123, symbol="AAPL", asset_name="Apple",
    exchange="QUANDL")
    position = Position(asset=a, amount=10, cost_basis=0.1,
    last_sale_price=15, last_sale_date="2017-01-01")
